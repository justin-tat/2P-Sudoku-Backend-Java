...
const boxSafe = (puzzleArray, emptyCell, num) => {
  ...
  for ( var boxRow of [0,1,2] ) {  // Each box region has 3 rows
    for ( var boxCol of [0,1,2] ) { // Each box region has 3 columns
...
function generateUniqueBoard (numHoles) {
  do {
...
//module.exports = { generateUniqueBoard, found};