...
public interface GameInterface extends JpaRepository<Game, Integer> {
  ...
  @Modifying
  @Query(value = "INSERT INTO games (p1_id, p2_id, p1_name, p2_name, p1_rating, p2_rating, is_finished) VALUES (:p1Id, :p2Id, :p1Name, :p2Name, :p1Rating, :p2Rating, '') RETURNING id, p1_id, p2_id  ",
  nativeQuery = true)
  List<Object> getIdsAfterInserting (@Param("p1Id") int p1Id,@Param("p2Id") int p2Id, @Param("p1Name") String p1Name, @Param("p2Name") String p2Name, @Param("p1Rating") int p1Rating, @Param("p2Rating") int p2Rating );
}
